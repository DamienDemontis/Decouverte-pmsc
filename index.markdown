...
<div class="hero-section">
  ...
  <div class="hero-visual animate__animated animate__fadeIn animate__delay-1s">
    <div class="tech-orbit">
      ...
      <a href="{{ site.baseurl }}/specialites/ia" class="tech-icon" data-specialty="Intelligence Artificielle" data-color="#7C3AED">
        <i class="fas fa-brain"></i>
        <span class="icon-tooltip">Intelligence Artificielle</span>
      </a>
      <a href="{{ site.baseurl }}/specialites/bigdata" class="tech-icon" data-specialty="Big Data" data-color="#0EA5E9">
        <i class="fas fa-database"></i>
        <span class="icon-tooltip">Big Data</span>
      </a>
      <a href="{{ site.baseurl }}/specialites/cloud" class="tech-icon" data-specialty="Cloud Computing" data-color="#2563EB">
        <i class="fas fa-cloud"></i>
        <span class="icon-tooltip">Cloud Computing</span>
      </a>
      <a href="{{ site.baseurl }}/specialites/cybersecurite" class="tech-icon" data-specialty="Cybersécurité" data-color="#DC2626">
        <i class="fas fa-shield-alt"></i>
        <span class="icon-tooltip">Cybersécurité</span>
      </a>
      <a href="{{ site.baseurl }}/specialites/iot" class="tech-icon" data-specialty="Internet of Things" data-color="#10B981">
        <i class="fas fa-microchip"></i>
        <span class="icon-tooltip">Internet of Things</span>
      </a>
      <a href="{{ site.baseurl }}/specialites/vrar" class="tech-icon" data-specialty="VR/AR" data-color="#F59E0B">
        <i class="fas fa-vr-cardboard"></i>
        <span class="icon-tooltip">VR/AR</span>
      </a>
      <!-- Spécialités Business & Management -->
      <a href="{{ site.baseurl }}/specialites/project-management" class="tech-icon" data-specialty="Project Management" data-color="#0D6EFD">
        <i class="fas fa-tasks"></i>
        <span class="icon-tooltip">Strategic Project Management</span>
      </a>
      <a href="{{ site.baseurl }}/specialites/fintech" class="tech-icon" data-specialty="Fintech" data-color="#0891B2">
        <i class="fas fa-chart-pie"></i>
        <span class="icon-tooltip">Fintech & Stratégies financières</span>
      </a>
      <a href="{{ site.baseurl }}/specialites/marketing" class="tech-icon" data-specialty="Marketing" data-color="#C026D3">
        <i class="fas fa-bullhorn"></i>
        <span class="icon-tooltip">Marketing & Influence</span>
      </a>
      <a href="{{ site.baseurl }}/specialites/ai-transformation" class="tech-icon" data-specialty="IA & Transformation" data-color="#3B82F6">
        <i class="fas fa-building-user"></i>
        <span class="icon-tooltip">IA & Transformation des organisations</span>
      </a>
      <a href="{{ site.baseurl }}/specialites/data-protection" class="tech-icon" data-specialty="Data Protection" data-color="#4F46E5">
        <i class="fas fa-user-shield"></i>
        <span class="icon-tooltip">Data, Protection & Sécurité</span>
      </a>
      <a href="{{ site.baseurl }}/specialites/rh-digitale" class="tech-icon" data-specialty="RH Digitale" data-color="#059669">
        <i class="fas fa-users-cog"></i>
        <span class="icon-tooltip">Digitalisation de la fonction RH</span>
      </a>
      <a href="{{ site.baseurl }}/specialites/sante-ia-iot" class="tech-icon" data-specialty="Santé & IA" data-color="#E11D48">
        <i class="fas fa-heartbeat"></i>
        <span class="icon-tooltip">Santé, IA & IoT</span>
      </a>
      <a href="{{ site.baseurl }}/specialites/data-science-bi" class="tech-icon" data-specialty="Data Science" data-color="#0284C7">
        <i class="fas fa-chart-line"></i>
        <span class="icon-tooltip">Data Science & Business Intelligence</span>
      </a>
      <a href="{{ site.baseurl }}/specialites/luxe-retail-tech" class="tech-icon" data-specialty="Luxe & Retail Tech" data-color="#A21CAF">
...
<div id="tech-specialties" class="specialties-grid">
  ...
  <div class="specialties-masonry">
    <div class="specialite-card" style="--card-color: #0EA5E9;">
      ...
      <a href="{{ site.baseurl }}/specialites/bigdata" class="btn-primary">Découvrir</a>
    </div>
    ...
    <div class="specialite-card" style="--card-color: #2563EB;">
      ...
      <a href="{{ site.baseurl }}/specialites/cloud" class="btn-primary">Découvrir</a>
    </div>
    ...
    <div class="specialite-card" style="--card-color: #DC2626;">
      ...
      <a href="{{ site.baseurl }}/specialites/cybersecurite" class="btn-primary">Découvrir</a>
    </div>
    ...
    <div class="specialite-card" style="--card-color: #7C3AED;">
      ...
      <a href="{{ site.baseurl }}/specialites/ia" class="btn-primary">Découvrir</a>
    </div>
    ...
    <div class="specialite-card" style="--card-color: #10B981;">
      ...
      <a href="{{ site.baseurl }}/specialites/iot" class="btn-primary">Découvrir</a>
    </div>
    ...
    <div class="specialite-card" style="--card-color: #F59E0B;">
      ...
      <a href="{{ site.baseurl }}/specialites/vrar" class="btn-primary">Découvrir</a>
    </div>
  </div>
</div>
...
<div id="business-specialties" class="specialties-grid business-grid">
  ...
  <div class="specialties-masonry">
    <div class="specialite-card" style="--card-color: #0D6EFD;">
      ...
      <a href="{{ site.baseurl }}/specialites/project-management" class="btn-primary">Découvrir</a>
    </div>
    ...
    <div class="specialite-card" style="--card-color: #0891B2;">
      ...
      <a href="{{ site.baseurl }}/specialites/fintech" class="btn-primary">Découvrir</a>
    </div>
    ...
    <div class="specialite-card" style="--card-color: #C026D3;">
      ...
      <a href="{{ site.baseurl }}/specialites/marketing" class="btn-primary">Découvrir</a>
    </div>
    ...
    <div class="specialite-card" style="--card-color: #3B82F6;">
      ...
      <a href="{{ site.baseurl }}/specialites/ai-transformation" class="btn-primary">Découvrir</a>
    </div>
    ...
    <div class="specialite-card" style="--card-color: #4F46E5;">
      ...
      <a href="{{ site.baseurl }}/specialites/data-protection" class="btn-primary">Découvrir</a>
    </div>
    ...
    <div class="specialite-card" style="--card-color: #059669;">
      ...
      <a href="{{ site.baseurl }}/specialites/rh-digitale" class="btn-primary">Découvrir</a>
    </div>
    ...
    <div class="specialite-card" style="--card-color: #E11D48;">
      ...
      <a href="{{ site.baseurl }}/specialites/sante-ia-iot" class="btn-primary">Découvrir</a>
    </div>
    ...
    <div class="specialite-card" style="--card-color: #0284C7;">
      ...
      <a href="{{ site.baseurl }}/specialites/data-science-bi" class="btn-primary">Découvrir</a>
    </div>
    ...
    <div class="specialite-card" style="--card-color: #A21CAF;">
      ...
      <a href="{{ site.baseurl }}/specialites/luxe-retail-tech" class="btn-primary">Découvrir</a>
    </div>
  </div>
</div>
